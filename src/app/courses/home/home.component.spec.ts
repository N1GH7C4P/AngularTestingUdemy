...
// Use in beforeEach
waitForAsync()
+ Supports actual http requests
- fixture.whenStable().then inflexible vs flush()

// Use when ever possible
fakeAsync()
- Doesnt support actual http backend calls.
+ flush() allows finer control over the asynchronous task queue.
+ nicer looking
